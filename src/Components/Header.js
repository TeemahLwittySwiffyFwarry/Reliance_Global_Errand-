...
const Header = () => {
  ...
  return (
    <header className="w-full fixed top-0 bg-gradient-to-r from-cyan-100 via-cyan-500 to-teal-800 shadow-lg p-4 flex justify-between items-center z-20">
  {/* Navbar Content */}


      {/* Logo Section */}
      <div id="home" className="text-2xl font-bold text-white flex items-center">
      ...
      <nav className="hidden md:flex space-x-6">
        <a href="#home" className="text-white hover:text-green-100 transition duration-300 ease-in-out">Home</a>
